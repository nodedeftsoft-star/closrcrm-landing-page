      ...
      <nav className="relative z-10 px-6 py-6">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          >
            ...
            <a href="https://closrfrontend.vercel.app/login" className="px-4 py-2 text-gray-600 hover:text-gray-900 transition-colors">Sign In</a>
            <a href="https://closrfrontend.vercel.app/signup" className="px-6 py-2.5 bg-[#3C8DFF] text-white rounded-full hover:shadow-lg hover:scale-105 transition-all duration-200">
              Get Started
            </a>
          </motion.div>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-12">
              <a href="https://closrfrontend.vercel.app/signup" className="group px-8 py-4 bg-gradient-to-r from-orange-500 to-amber-500 text-white rounded-full hover:shadow-xl hover:scale-105 transition-all duration-200 flex items-center justify-center gap-2">
                Get Started for $1
